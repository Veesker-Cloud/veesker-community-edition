...
| **v0.5.0-beta.2** | ✅ May 2026 | Directory inspector fallback to `ALL_DIRECTORIES` (ORA-00942), Scheduler Jobs `ALL_SCHEDULER_JOBS` + `USER_SCHEDULER_JOBS` parallel fallback with dedup |
